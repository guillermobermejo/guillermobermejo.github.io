(function($) {
	...
	// Gerrymandering Project	
		...
		$window.on('load', function() {
			...
			$('#gerrymandering-project-header-table').poptrox({
				caption: function($a) { return $a.next('h3').text(); },
				overlayColor: '#2c2c2c',
				overlayOpacity: 0.85,
				popupCloserText: '',
		...
		// Section: Project-info
			...
			$window.on('load', function() {
				...
				$('#section-gerrymandering-project-info').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
		...
		// Section: Overview Section.
			...
			$window.on('load', function() {
				...
				$('#section-gerrymandering-overview').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
		...
		// Section: Testing Measures Section.

			$window.on('load', function() {

				$('#section-gerrymandering-testing-measures').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
		...
		// Section: Design Section.
			...
			$window.on('load', function() {
				...
				$('#section-gerrymandering-project-design').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
		...
		// Section: Implementation Section.
			...
			$window.on('load', function() {
				...
				$('#section-gerrymandering-implementation').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
		...
		// Section: SeaWulf Section.

			$window.on('load', function() {

				$('#section-gerrymandering-seawulf-cluster').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
		...
		// Section: Back-End Section.
			...
			$window.on('load', function() {
				...
				$('#section-gerrymandering-backend').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
		...
		// Section: Contribution Section.
			...
			$window.on('load', function() {
				...
				$('#section-gerrymandering-contribution').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
		...
		// Section: Conclusion.
			...
			$window.on('load', function() {
				...
				$('#section-gerrymandering-conclusion').poptrox({
					caption: function($a) { return $a.next('h3').text(); },
					overlayColor: '#2c2c2c',
					overlayOpacity: 0.85,
					popupCloserText: '',
